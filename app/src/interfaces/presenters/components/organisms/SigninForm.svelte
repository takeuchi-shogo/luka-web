...
<script lang="ts">
	...
	import SocialButton from '../atoms/button/SocialButton.svelte'
...
<form class="bg-white shadow rounded sm:w-600 w-full p-10">
	...
	<SocialButton class="bg-orange-500" text={ 'Continue with Google'}>
	...
	<SocialButton class="bg-black" text={ 'Githubアカウントでログイン' }>
	...
	<SocialButton class="bg-blue-500" text={ 'Twitterアカウントでログイン' }>
	...
	<SocialButton text={ 'instagramアカウントでログイン' }>
