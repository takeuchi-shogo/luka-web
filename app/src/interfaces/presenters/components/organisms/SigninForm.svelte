...
<form class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
	...
	<button aria-label="Continue with github" type="button" class="outline-none ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
	...
	<button aria-label="Continue with twitter" type="button" class="outline-none ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
