...
<div class="pt-8 sm:flex group">
	...
	<div>
		...
		<h2 class="mt-3 font-medium leading-6">{ title }</h2>
		<p class="mt-2 text-lg text-gray-500">{ discription }</p>
		<div class="pt-8">
